...
extension CustomWidget on Widget {
  ...
  // By default it is black only so no need to worry you had only change for white
  // status bar screen no need for other screens.
  // Add the white status bar if you wanted to see the icons in a white color
  // Example:
  // Use it on top element of the application
  // @override
  // Widget build(BuildContext context) {
  //       return (Any widget or scaffold or safeArea).addWhiteStatusBar();
  // }
  Widget addWhiteStatusBar() => AnnotatedRegion<SystemUiOverlayStyle>(
        value: AppTheme.whiteSystemOverlayUi,
        child: this,
      );

  // Add the black status bar if you wanted to see the icons in a black color
  Widget addBlackStatusBar() => AnnotatedRegion<SystemUiOverlayStyle>(
        value: AppTheme.blackSystemOverlayUi,
        child: this,
      );
